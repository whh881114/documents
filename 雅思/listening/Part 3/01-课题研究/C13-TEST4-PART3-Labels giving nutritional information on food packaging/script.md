...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>Did you have any idea how many calories they contain?</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>I thought comparing the different labelling systems used by food manufacturers was interesting.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>Those findings weren't that conclusive and it was quite a small-scale study.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>And not on all products.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>But I don't think they targeted the right people.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>But it's good to get feedback from all socio-economic groups.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>But if they hadn't interviewed participants face-to-face, they could have used a much bigger sample size.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>How were they selected?</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>The thing that wasn't stated was how often they bought packaged food - all we know is how frequently they used the supermarket.</div>
</div>
