...
- Script: https://ieltscat.xdf.cn/intensive/intensive/1740/2/1
- Sentence count: 51
...
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div><strong>HAZAL:</strong></div>
  <div>Tom, could I ask you for some advice, please?</div>
</div>
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  <div style="text-align:right;">2.</div>
  <div><strong>TOM:</strong></div>
  <div>Yes of course, if you think I can help.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div><strong>HAZAL:</strong></div>
  <div>It's my first media studies assignment, and I'm not sure how to go about it.</div>
  <div></div>
  <div></div>
  <div>You must have done it last year.</div>
</div>
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  <div style="text-align:right;">4.</div>
  <div><strong>TOM:</strong></div>
  <div>Is that the one comparing the coverage of a particular story in a range of newspapers?</div>
</div>
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
...
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div><strong>TOM:</strong></div>
  <div>Oh yes, I really enjoyed writing it.</div>
</div>
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  <div style="text-align:right;">7.</div>
  <div><strong>HAZAL:</strong></div>
  <div>So what sort of things do I need to compare?</div>
</div>
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  <div style="text-align:right;">8.</div>
  <div><strong>TOM:</strong></div>
  <div>Well, there are several things.</div>
  <div></div>
  <div></div>
  <div>For example, there's the question of which page of the newspaper the item appears on.</div>
</div>
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  <div style="text-align:right;">9.</div>
  <div><strong>HAZEL:</strong></div>
  <div>You mean, because there's a big difference between having it on the front page and the bottom of page ten, for instance?</div>
</div>
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
...
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div><strong>THEN YOU'LL NEED TO LOOK AT HOW THE ITEM IS PUT TOGETHER:</strong></div>
  <div>what structure is it given?</div>
</div>
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
...
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div><strong>AND THAT RELATES TO A VERY IMPORTANT POINT:</strong></div>
  <div>what's the writer's purpose,</div>
</div>
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
...
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>Good luck with the assignment, Hazel.</div>
</div>
