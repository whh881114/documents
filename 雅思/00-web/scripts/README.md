...
Run `Build-ListeningCatalog.ps1` after renaming or adding listening scripts. It scans `listening/Part1` through `Part4` and rebuilds `assets/data/listening-catalog.js`.
