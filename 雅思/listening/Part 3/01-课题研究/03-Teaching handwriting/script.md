...
- Part: 3
- Category: 01-课题研究
- Script: https://ieltscat.xdf.cn/intensive/intensive/1832/2/1
- Sentence count: 38
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>And all the evidence suggests children should learn to write by hand before they learn to type.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>The physical act of writing helps children to remember letters.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>I’d never associated spatial awareness with handwriting either.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>I liked the idea of using one of those pens that lights up if you press too hard.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>It’s not as frustrating for them if they get things wrong – on a keyboard they can be more willing to have a go.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>I was always worried that my poor handwriting affected my exam results.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>Touch typing still isn’t taught in most schools, which is a shame.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>However, the fact is that people are writing by hand less and less and relying on digital devices.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>But my mum is shocked by my awful spelling and the fact that my punctuation is really inconsistent.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>Personally, I miss writing by hand.</div>
  <div></div>
  <div></div>
  <div>I hardly ever write anything now.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>I feel the same way.</div>
  <div></div>
  <div></div>
  <div>I used to write a diary by hand and now I do that digitally.</div>
  <div></div>
  <div></div>
  <div>It just seems less effort to do it that way.</div>
  <div></div>
  <div></div>
  <div>So it’s not just a problem…</div>
</div>
