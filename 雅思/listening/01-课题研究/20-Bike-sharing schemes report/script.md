# Bike-sharing schemes report

- Source: 剑雅16 Test 4-Section 3
- Script: https://ieltscat.xdf.cn/intensive/intensive/1766/2/1
- Sentence count: 55
...
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div>Now that we've done all the research into bike-sharing schemes in cities around the world, we need to think about how we're going to organise our report.</div>
</div>
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  <div style="text-align:right;">2.</div>
  <div><strong>AMY:</strong></div>
  <div>Right.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>OK so now we've thought about ...</div>
</div>

> Note: Sentence 55 is truncated this way on the source page.
