...
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>And I don't suppose it'd need much equipment; we're not doing chemical analysis or anything.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>We need to have a word with the tutor if we're going to go ahead with it though.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>I looked through it for my last experiment, though it wasn't all that relevant there.</div>
  <div></div>
  <div></div>
  <div>It would be for this experiment, though.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>I knew a bit about it already, but not about this research.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>So the first thing we have to do is find our seeds.</div>
  <div></div>
  <div></div>
  <div>I think vegetable seeds would be best.</div>
  <div></div>
  <div></div>
  <div>And obviously they mustn't all be the same size.</div>
  <div></div>
  <div></div>
  <div>So, how many sorts do we need?</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>So then we get planting.</div>
  <div></div>
  <div></div>
