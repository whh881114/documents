...
- Script: https://ieltscat.xdf.cn/intensive/intensive/1753/2/1
- Sentence count: 51
...
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div><strong>SUSIE:</strong></div>
  <div>So Luke, for our next psychology assignment we have to do something on sleep and dreams.</div>
</div>
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
...
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>Then we need to think about who we'll do the study on.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 4.5em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>It needs to be self-reporting I think.</div>
  <div></div>
  <div></div>
