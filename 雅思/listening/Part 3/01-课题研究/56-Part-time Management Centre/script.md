...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>My name's Brian Ardley.</div>
  <div></div>
  <div></div>
  <div>I've decided to enroll on a part- time management course.</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>But would it be possible to sit in on a teaching session, to see what it's like?</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>What about facilities for young children?</div>
  <div></div>
  <div></div>
...
<div style="display:grid;grid-template-columns:2.5em 6em minmax(0,1fr);column-gap:0.25em;margin:0.35em 0;">
  ...
  <div></div>
  <div></div>
  <div>I'd better go home and fill in the enrolment form.</div>
  <div></div>
  <div></div>
